...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    #activation_rowsum= np.sum(A2, axis=1)
    correct_class = A2[range(len(y)), y].reshape(-1,1)
    #entire_score = A2 / activation_rowsum.reshape(-1,1)
    #y_i = correct_class / activation_rowsum 
  ...
  def train(self, X, y, X_val, y_val,
    ...
    W1 = self.params['W1']
    b1 = self.params['b1'].reshape(1,-1)
    W2 = self.params['W2']
    b2 = self.params['b2'].reshape(1,-1)
